...
import { APSOTransactions } from './APSOtransactions.model';

@Component({
  selector: 'fury-quotes-create-update',
  templateUrl: './APSOtransactions-create-update.component.html',
  styleUrls: ['./APSOtransactions-create-update.component.scss']
})
export class APSOTransactionsCreateUpdateComponent implements OnInit {

  static id = 100;
  form: UntypedFormGroup;
  mode: 'create' | 'update' = 'create';
  quoteDetails: APSOTransactions[] = [];
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<APSOTransactionsCreateUpdateComponent>,
  ...
  ngOnInit() {
    if (this.defaults) {
      ...
      this.defaults = {} as APSOTransactions;
    }
    ...
    this.form = this.fb.group({
      ...
      serviceOrderId: [this.defaults.serviceOrderId || 0],

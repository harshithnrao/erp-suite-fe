...
@Component({
  ...
  templateUrl: './budget-create-update.component.html',
  styleUrls: ['./budget-create-update.component.scss']
})
export class BudgetCreateUpdateComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<BudgetCreateUpdateComponent>,
  ...
  ngOnInit() {
    ...
    this.form = this.fb.group({
      ...
      user_type: [this.defaults.user_type || ''],
    });
  }

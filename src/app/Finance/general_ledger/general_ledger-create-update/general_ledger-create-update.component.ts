...
import { GeneralLedger } from './general_ledger.model';

@Component({
  selector: 'fury-quotes-create-update',
  templateUrl: './general_ledger-create-update.component.html',
  styleUrls: ['./general_ledger-create-update.component.scss']
})
export class GeneralLedgerCreateUpdateComponent implements OnInit {

  static id = 100;
  form: UntypedFormGroup;
  mode: 'create' | 'update' = 'create';
  quoteDetails: GeneralLedger[] = [];
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<GeneralLedgerCreateUpdateComponent>,
  ...
  ngOnInit() {
    if (this.defaults) {
      ...
      this.defaults = {} as GeneralLedger;
    }
    ...
    this.form = this.fb.group({
      ...
      transactionDate: [this.defaults.transactionDate || ''],

...
import { APPOTransactions } from './APPOtransactions.model';

@Component({
  selector: 'fury-quotes-create-update',
  templateUrl: './APPOtransactions-create-update.component.html',
  styleUrls: ['./APPOtransactions-create-update.component.scss']
})
export class APPOTransactionsCreateUpdateComponent implements OnInit {

  static id = 100;
  form: UntypedFormGroup;
  mode: 'create' | 'update' = 'create';
  quoteDetails: APPOTransactions[] = [];
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<APPOTransactionsCreateUpdateComponent>,
  ...
  ngOnInit() {
    if (this.defaults) {
      ...
      this.defaults = {} as APPOTransactions;
    }
    console.log(this.defaults);
    this.form = this.fb.group({
      id: [this.defaults.id || 0],
      fromAccount: [this.defaults.fromAccount || ''],
      apAccountId: [this.defaults.apAccountId || 0],
      toAccount: [this.defaults.toAccount || ''],
      purchaseOrderId: [this.defaults.purchaseOrderId || 0],
      transactionDate: [this.defaults.transactionDate || null],
      totalAmount: [this.defaults.totalAmount || 0],
      pendingAmount: [this.defaults.pendingAmount || 0],
      description: [this.defaults.description || ''],
      transactionType: [this.defaults.transactionType || ''],

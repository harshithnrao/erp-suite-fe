...
@Component({
  ...
  templateUrl: './po-create-update.component.html',
  styleUrls: ['./po-create-update.component.scss']
})
export class POCreateUpdateComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<POCreateUpdateComponent>,
  ...
  ngOnInit() {
    ...
    this.form = this.fb.group({
      ...
      itemCount: [this.defaults?.itemCount || 0],
      vendorId: [this.defaults?.vendorId || 0],
      orderDate: [this.defaults?.orderDate || ''],

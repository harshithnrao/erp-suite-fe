...
export class DashboardComponent implements OnInit {
  ...
  userDetail = Utility.userDetails;
  ...
  salesSummary: any;
  customerCount = 0;
  // menuItems: import("c:/Users/csjna/OneDrive/Documents/ERP_major/ERP_FE/ERP-fe/src/app/HRMS/hrms.service").MenuItem[];
  menuItems: import("src/app/HRMS/hrms.service").MenuItem[];
  http: any;
  ...
  loadDashboardData() {
    this.http.get('assets/homescreen/dashboard-data.json').subscribe(
      (data: any) => {
  ...
  async getDashboardData() {
      ...
      this.salesSummary = this.dashboardService.screenModel.salesSummary;
      this.customerCount = this.dashboardService.screenModel.customerCount;
  }

  initializeDummyWidgets() {

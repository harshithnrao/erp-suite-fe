...
@Component({
  ...
  templateUrl: './log-create-update.component.html',
  styleUrls: ['./log-create-update.component.scss']
})
export class LogCreateUpdateComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<LogCreateUpdateComponent>,
